export const questions = [ //대괄호 배열 데이터 시작
  { //중괄호 js객체 데이터 시작(속성과 컨텐츠로 구성함)
    number: '01', 
...
export const mbtis = { //결과값 숫자 == results의 배열 인덱스
  entj: 0,
  entp: 0,
  estp: 0,
  esfp: 1,
...
//export : 변수(questions, results, mbtis)의 객체, 배열 데이터를 js밖으로 내보내기 위함 
